"""Prepare the private Dataset-A-train domain-hotword candidates for R12 M0 Paraformer."""
...
from xh202615.r12_asr_hotword import prepare_hotword_candidates
...
def _parse_capacities(value: str | None) -> list[int]:
    if value is None:
        return []
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = prepare_hotword_candidates(
